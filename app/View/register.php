...
<div class="navbar navbar-inverse navbar-static-top ">
           ...
           <div class="jumbotron">
                ...
                <div class="container">
                            ...
                            <form action="./?c=RentHandle&m=handler" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-7">
                                    <input type="text" id="pwd" class="form-control" name="pwd" placeholder='password'>
                                    </div>                 
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-7">
                                    <input type="text" id="pwd-c" class="form-control" name="pwd-c" placeholder='password'>
                                    </div>                 
                                </div>

                                <div class="form-group">
                                    <label for="" class="col-xs-5 col-sm-3 control-label">性别：</label>
                                   
                                    <div class="radio col-xs-2">
                                        <label>
                                        <input type="radio" name="sex" id="sex" value="option1" checked>男
                                    ...
                                    <div class="radio col-xs-2">
                                        <label>
                                        <input type="radio" name="sex" id="sex" value="option1" checked>女
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-7">
                                    <input type="text" id="tel" class="form-control" name="tel" placeholder='password'>
                                    </div>                 
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-7">
                                    <input type="text" id="email" class="form-control" name="email" placeholder='password'>
                                    </div>                 
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-xs-8 col-sm-7">
                                    <input type="text" id="idnum" class="form-control" name="idnum" placeholder='password'>
                                    </div>                 
                                </div>

                                <div class="form-group">
                                    <div class="col-md-offset-4 col-sm-4 col-xs-3">
                                    <input type="submit" name="sub" value="确认" class="btn btn-success">
                                    </div>
